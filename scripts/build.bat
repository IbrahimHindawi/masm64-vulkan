...
set corelibs=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib
...
ml64.exe %mlargs% /IC:\devel\masm64-opengl\extern\masm64-custom-sdk\masm64 ..\source\%project_name%.asm /link %linkargs%
